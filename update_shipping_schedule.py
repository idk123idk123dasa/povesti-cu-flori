...
- Poșta Română Recomandat, joi săptămânal, 7-14 zile lucrătoare
...
SIMPLE = [
    # USPS
    ('USPS Ground Advantage', 'Poșta Română Recomandat'),
    ...
    ('trimise prin poștă obișnuită',
     'expediate prin Poșta Română Recomandat'),
    ('trimise prin poştă obişnuită',
     'expediate prin Poșta Română Recomandat'),
    ('poștă obișnuită Poșta Română',
     'Poșta Română Recomandat'),
    ('poștă obișnuită',
     'Poșta Română Recomandat'),
    # Zile/schedule
    ...
    ('Prima scrisoare este expediată cu urmărire USPS. Toate scrisorile rămase sunt trimise prin poștă obișnuită de două ori pe lună.',
     'Expedierea se face în fiecare joi. Livrare 7–14 zile lucrătoare prin Poșta Română Recomandat.'),
    ...
    ('Scrisorile rămase vor fi trimise prin poștă obișnuită și, în general, vor fi trimise prin poștă în a 2-a și a 4-a vineri a fiecărei luni.',
     'Toate scrisorile sunt expediate prin Poșta Română Recomandat în fiecare joi.'),
...
NEW_SHIPPING_BLOCK = (
    'Livrare prin Poșta Română Recomandat\n'
    'Toate scrisorile sunt trimise prin Poșta Română Recomandat, cu tracking, direct în cutia ta poștală.\n'
...
OLD_SHIPPING_BLOCK = (
    ...
    'Toate scrisorile sunt trimise prin Poșta Română Recomandat, direct în cutia ta poștală.\n'
    '- Livrare: 3-5 zile lucrătoare\n'
    '- Tracking: primești email cu codul de urmărire la expediere\n'
    '- Cost: GRATUIT (inclus în preț)\n'
    '- Acoperire: toată România'
